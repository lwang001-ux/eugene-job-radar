...
GOOGLE_JOBS_QUERIES = [
    ...
    "senior graphic designer southern california",
    ...
    "independent school design teacher southern california",
    "private school design teacher southern california",
    "independent school makerspace coordinator southern california",
    "museum educator southern california",
]

WEB_SEARCH_QUERIES = [
    'site:linkedin.com/jobs/view "graphic designer" "southern california"',
    'site:linkedin.com/jobs/view "senior graphic designer" "southern california"',
    ...
    'site:indeed.com/viewjob "senior graphic designer" "southern california"',
...
def search_web_results():
    print("Weekly search: LinkedIn / Indeed / EdJoin")
    results = []
    seen = set()
    ...
    for q in WEB_SEARCH_QUERIES:
        ...
        for item in items[:4]:
            ...
            if not any(x in link_lower for x in ["linkedin.com", "indeed.com", "edjoin.org", "school", ".edu", "museum"]):
                continue
